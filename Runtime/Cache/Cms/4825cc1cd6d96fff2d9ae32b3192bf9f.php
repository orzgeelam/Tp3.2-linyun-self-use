    ...
    <div class="form-group item_<?php echo ($form["name"]); ?> <?php echo ($form["extra_class"]); ?>">
        ...
        <script type="text/javascript">
            $(function(){
                ...
                <?php case "dateranger": ?><link rel="stylesheet" href="/cyw/80hou/Public/libs/bootstrap-daterangepicker/daterangepicker.css">
    <style>
        .dateranger{
            width: 190px !important;
        }
    </style>
    <script src="/cyw/80hou/Public/libs/bootstrap-daterangepicker/moment.min.js"></script>
    <script src="/cyw/80hou/Public/libs/bootstrap-daterangepicker/daterangepicker.js"></script>
                                            ...
                                            <td>
                                                <?php if ($column['name'] === 'right_button') : ?>
                                                    <?php if((!empty($data['right_button']) && is_array($data['right_button']))): foreach ($data['right_button'] as $rb) : ?>
                                                        <a <?php echo ((isset($rb['attribute']) && ($rb['attribute'] !== ""))?($rb['attribute']):''); ?>><?php echo ($rb['title']); ?></a>
