...
Source Database       : orzgee

Target Server Type    : MYSQL
Target Server Version : 50553
File Encoding         : 65001

Date: 2019-01-23 16:30:44
*/
...
INSERT INTO `xilu_admin_access` VALUES ('2', '2', '2', '1548231523', '1548231523', '0', '1');
...
-- ----------------------------
INSERT INTO `xilu_admin_addon` VALUES ('1', 'ModelConfigEditor', '模型配置器', '用于编辑已有模块的配置', '\"\"', 'yangweijie', '0.2', '0', '0', '1479866990', '1479866990', '0', '1');
INSERT INTO `xilu_admin_addon` VALUES ('3', 'YuntxSms', '云通讯插件', '用于配置并发送云通讯短信', '{\"account_sid\":\"\",\"account_token\":\"\",\"app_id\":\"\",\"debug\":\"1\"}', 'yangweijie', '0.1', '0', '0', '1548228077', '1548228077', '0', '1');
...
INSERT INTO `xilu_admin_config` VALUES ('2', '网站标题', 'WEB_SITE_TITLE', '房车服务号', '1', 'text', '', '网站标题前台显示标题', '1378898976', '1379235274', '2', '1');
INSERT INTO `xilu_admin_config` VALUES ('3', '网站LOGO', 'WEB_SITE_LOGO', '', '1', 'picture', '', '网站LOGO', '1407003397', '1407004692', '4', '1');
INSERT INTO `xilu_admin_config` VALUES ('4', '网站域名', 'WEB_URL', '', '1', 'text', '', '', '1483437312', '1483437342', '0', '1');
INSERT INTO `xilu_admin_config` VALUES ('5', '客服热线', 'WXWAP_HOTLINE', '', '1', 'text', '', '', '1488008635', '1488008664', '5', '1');
INSERT INTO `xilu_admin_config` VALUES ('6', '文件上传大小', 'UPLOAD_FILE_SIZE', '100', '2', 'num', '', '文件上传大小单位：MB', '1428681031', '1428681031', '1', '1');
INSERT INTO `xilu_admin_config` VALUES ('7', '图片上传大小', 'UPLOAD_IMAGE_SIZE', '100', '2', 'num', '', '图片上传大小单位：MB', '1428681071', '1428681071', '2', '1');
INSERT INTO `xilu_admin_config` VALUES ('8', '后台多标签', 'ADMIN_TABS', '0', '2', 'radio', '0:关闭\r\n1:开启', '', '1453445526', '1453445526', '3', '0');
INSERT INTO `xilu_admin_config` VALUES ('9', '分页数量', 'ADMIN_PAGE_ROWS', '10', '2', 'num', '', '分页时每页的记录数', '1434019462', '1434019481', '4', '1');
INSERT INTO `xilu_admin_config` VALUES ('10', '后台主题', 'ADMIN_THEME', 'aliyun', '2', 'select', 'admin:默认主题\r\naliyun:阿里云风格\r\nweixin:微信风格\r\ngreen:绿色主题\r\npink:粉色主题\r\nred:红色主题', '后台界面主题', '1436678171', '1548214061', '5', '1');
INSERT INTO `xilu_admin_config` VALUES ('11', '配置分组', 'CONFIG_GROUP_LIST', '1:基本\r\n2:系统\r\n3:开发\r\n4:部署\r\n5:微信\r\n6:后台', '2', 'array', '', '配置分组', '1379228036', '1548227594', '7', '1');
INSERT INTO `xilu_admin_config` VALUES ('12', '开发模式', 'DEVELOP_MODE', '1', '3', 'select', '1:开启\r\n0:关闭', '开发模式下会显示菜单管理、配置管理、数据字典等开发者工具', '1432393583', '1432393583', '1', '1');
INSERT INTO `xilu_admin_config` VALUES ('13', '是否显示页面Trace', 'SHOW_PAGE_TRACE', '0', '3', 'select', '0:关闭\r\n1:开启', '是否显示页面Trace信息', '1387165685', '1387165685', '2', '1');
INSERT INTO `xilu_admin_config` VALUES ('14', '系统加密KEY', 'AUTH_KEY', 'YwYH?hNv,?Q?H&h{ox:}$C!<#)\"-j[T;Z~N~cyxXI,(L]czF@N+;&qbA$h;HG.Ph', '3', 'textarea', '', '轻易不要修改此项，否则容易造成用户无法登录；如要修改，务必备份原key', '1438647773', '1438647815', '3', '1');
INSERT INTO `xilu_admin_config` VALUES ('15', 'URL模式', 'URL_MODEL', '3', '4', 'select', '1:PATHINFO模式\r\n2:REWRITE模式\r\n3:兼容模式', '', '1438423248', '1438423248', '1', '1');
INSERT INTO `xilu_admin_config` VALUES ('16', '微信APPID', 'wechat_appid', '', '5', 'text', '', '', '1479866418', '1479866418', '1', '1');
INSERT INTO `xilu_admin_config` VALUES ('17', '微信APPSECRET', 'wechat_appsecret', '', '5', 'text', '', '', '1479866483', '1479887153', '2', '1');
INSERT INTO `xilu_admin_config` VALUES ('18', '微信TOKEN', 'wechat_apptoken', '', '5', 'text', '', '', '1479866587', '1479866587', '3', '1');
INSERT INTO `xilu_admin_config` VALUES ('19', '微信授权回调地址', 'wechat_url', 'weixin/auth_back', '5', 'text', '', '', '1479866632', '1479866632', '4', '1');
INSERT INTO `xilu_admin_config` VALUES ('20', '微信商户id', 'wechat_merchant_id', '', '5', 'text', '', '', '1479866670', '1479866670', '5', '1');
INSERT INTO `xilu_admin_config` VALUES ('21', '微信商户key', 'wechat_key', '', '5', 'text', '', '', '1479866703', '1479866703', '6', '1');
...
INSERT INTO `xilu_admin_group` VALUES ('2', '0', '管理员', 'fa-user', '{\"Admin\":[\"1\",\"2\",\"3\",\"4\",\"13\",\"14\",\"15\",\"61\",\"62\",\"63\",\"17\",\"18\",\"19\",\"21\",\"22\",\"64\",\"65\",\"66\",\"23\",\"24\",\"25\",\"26\",\"67\",\"68\",\"69\",\"70\",\"28\",\"29\",\"30\",\"71\",\"72\",\"73\",\"32\",\"33\",\"34\",\"74\",\"75\",\"76\",\"36\",\"44\",\"45\",\"46\",\"47\",\"77\",\"78\",\"49\",\"50\",\"51\",\"52\",\"53\",\"54\",\"55\",\"56\",\"79\",\"80\",\"85\",\"81\",\"82\",\"83\",\"84\"],\"Wxwap\":[\"1\",\"2\",\"3\",\"4\"]}', '1541657200', '1548231912', '1', '1');
...
INSERT INTO `xilu_admin_module` VALUES ('7', 'Wxwap', '微信站', '', 'fa fa-comments', '#F9B440', '微信站模块', 'yangweijie', '1.0.0', '', '{\"test\":\"\"}', '{\"1\":{\"id\":\"1\",\"pid\":\"0\",\"title\":\"\\u540e\\u53f0\\u7ba1\\u7406\",\"url\":\"\",\"icon\":\"fa fa-comments\",\"sort\":\"\"},\"2\":{\"id\":\"2\",\"pid\":\"1\",\"title\":\"\\u7528\\u6237\\u7ba1\\u7406\",\"url\":\"\",\"icon\":\"fa fa-folder-open-o\",\"sort\":\"\"},\"3\":{\"id\":\"3\",\"pid\":\"2\",\"title\":\"\\u5fae\\u4fe1\\u7ad9\",\"url\":\"Wxwap\\/Index\\/index\",\"icon\":\"fa fa-comments\"},\"4\":{\"pid\":\"1\",\"title\":\"\\u5fae\\u4fe1\\u7ad9\\u8bbe\\u7f6e\",\"url\":\"\",\"icon\":\"fa fa-wrench\",\"sort\":\"\",\"id\":\"4\"}}', '0', '1486362129', '1548227979', '0', '1');
...
-- ----------------------------
INSERT INTO `xilu_admin_user` VALUES ('1', '1', '开发', 'xilukeji', 'c73da6e4246c88ca3e959c0d68083a93', '1438651748', '1548231639', '1');
INSERT INTO `xilu_admin_user` VALUES ('2', '1', '管理员', 'admin', 'e811fee0842e9e7aa2a989058e5b402d', '1548231509', '1548231509', '1');
